...
-- Uses existing users from users_rows.csv:
--  Professor (a@gmail.com): 4c00fceb-c9e0-4a2d-9637-004e00e8f24c
--  TA        (b@gmail.com): 0478a28b-a2c4-4754-bf11-68e42564829d
--  Student   (c@gmail.com): a004f4ff-0b2e-4e5e-9ab0-e4072663ca03
--
-- This script is safe to run multiple times: it uses fixed UUIDs and
-- INSERT ... ON CONFLICT (id) DO NOTHING for idempotence.

BEGIN;

-- -------------------------------------------------------------------
-- Course: CS5432 – AI-assisted Coding
-- -------------------------------------------------------------------
...
VALUES (
  ...
  'AI4DEV',
  '4c00fceb-c9e0-4a2d-9637-004e00e8f24c'
)
ON CONFLICT (id) DO NOTHING;

-- Enroll TA and student in CS5432

INSERT INTO public.course_enrollments (id, course_id, user_id, role, joined_at)
VALUES
  (
    '55555555-6666-4777-8888-999999999999',
    '11111111-2222-4333-8444-555555555555',
    '0478a28b-a2c4-4754-bf11-68e42564829d',
    'ta',
    NOW() - INTERVAL '5 days'
  ),
  (
    ...
    '11111111-2222-4333-8444-555555555555',
    'a004f4ff-0b2e-4e5e-9ab0-e4072663ca03',
    'student',
    NOW() - INTERVAL '4 days'
  )
ON CONFLICT (id) DO NOTHING;
...
-- Week 1 – past, ended session
INSERT INTO public.sessions (id, course_id, title, date, start_time, end_time, status, created_at)
VALUES (
  '22222222-3333-4444-8555-666666666666',
  '11111111-2222-4333-8444-555555555555',
  'Week 1 – Getting Started with AI Tools',
...
-- Week 2 – active session (main playground)
INSERT INTO public.sessions (id, course_id, title, date, start_time, end_time, status, created_at)
VALUES (
  '33333333-4444-4555-8666-777777777777',
  '11111111-2222-4333-8444-555555555555',
  'Week 2 – Debugging with AI Assistance',
  CURRENT_DATE,
  '17:00',
  '19:00',
  'active',
...
-- Week 3 – upcoming, scheduled
INSERT INTO public.sessions (id, course_id, title, date, start_time, end_time, status, created_at)
VALUES (
  '44444444-5555-4666-8777-888888888888',
  '11111111-2222-4333-8444-555555555555',
  'Week 3 – Refactoring Legacy Code with AI',
...
-- Assign TA to all three sessions

INSERT INTO public.session_ta_assignments (id, session_id, ta_id, created_at)
VALUES
  (
    '77777777-8888-4999-9000-aaaaaaaaaaaa',
    '22222222-3333-4444-8555-666666666666',
    '0478a28b-a2c4-4754-bf11-68e42564829d',
    NOW() - INTERVAL '7 days'
  ),
  (
    '88888888-9999-4aaa-a111-bbbbbbbbbbbb',
    '33333333-4444-4555-8666-777777777777',
    '0478a28b-a2c4-4754-bf11-68e42564829d',
    NOW() - INTERVAL '2 days'
  ),
  (
    '99999999-aaaa-4bbb-b222-cccccccccccc',
    '44444444-5555-4666-8777-888888888888',
    '0478a28b-a2c4-4754-bf11-68e42564829d',
    NOW()
  )
...
-- -------------------------------------------------------------------
-- Questions for Week 2 – Debugging with AI Assistance (active)
-- -------------------------------------------------------------------
-- All questions are from the same student (c@gmail.com).
-- We pre-set queue_position so that:
--  - In-progress question has position 1
--  - Queued questions at positions 2, 3, 4
--  - Deferred question at position 5 (back of queue)
--  - Resolved questions have queue_position = -1

-- Q1: In progress, high priority debugging
INSERT INTO public.questions (
  id, session_id, student_id, title, description, code_snippet, error_message,
...
VALUES (
  ...
  'I compared the old and new implementations and printed the inputs inside the failing tests. I also asked the AI to explain the diff, but the explanation didn''t mention the anonymous-user case. I tried adding another if branch but I''m not confident in the logic.',
  'debugging',
  'high',
  'in_progress',
  1,
...
-- Q2: Queued, high priority debugging
INSERT INTO public.questions (
  id, session_id, student_id, title, description, code_snippet, error_message,
  what_tried, category, priority, status, queue_position,
  claimed_by, resolution_note, claimed_at, deferred_at, resolved_at, created_at
...
-- Q3: Queued, medium priority conceptual
INSERT INTO public.questions (
  id, session_id, student_id, title, description, code_snippet, error_message,
  what_tried, category, priority, status, queue_position,
  claimed_by, resolution_note, claimed_at, deferred_at, resolved_at, created_at
...
VALUES (
  ...
  NULL,
  'I read the course notes on soundness and watched the lecture on type inference again. I also asked the AI to ''make the types stricter'' but it sometimes breaks the build. I''d like guidance on a review strategy.',
  'conceptual',
  'medium',
  'queued',
  3,
...
-- Q6–Q7: Resolved questions in the active session (for stats/history)
INSERT INTO public.questions (
  id, session_id, student_id, title, description, code_snippet, error_message,
  what_tried, category, priority, status, queue_position,
  claimed_by, resolution_note, claimed_at, deferred_at, resolved_at, created_at
...
(
  ...
  -1,
  '0478a28b-a2c4-4754-bf11-68e42564829d',
  'Discussed concrete prompt templates and how to lock context to a single function.',
  NOW() - INTERVAL '1 hour',
  NULL,
  NOW() - INTERVAL '50 minutes',
...
(
  ...
  -1,
  '0478a28b-a2c4-4754-bf11-68e42564829d',
  'Reviewed EXPLAIN output and suggested a better index strategy and WHERE clause.',
...
-- -------------------------------------------------------------------
-- Questions for Week 1 – Getting Started with AI Tools (ended)
-- -------------------------------------------------------------------

-- Q8: resolved during the session
INSERT INTO public.questions (
  id, session_id, student_id, title, description, code_snippet, error_message,
  what_tried, category, priority, status, queue_position,
  claimed_by, resolution_note, claimed_at, deferred_at, resolved_at, created_at
...
VALUES (
  ...
  -1,
  '0478a28b-a2c4-4754-bf11-68e42564829d',
  'Clarified when AI assistance is allowed and how to document usage in the README.',
...
-- Q9–Q10: unresolved when the session ended
INSERT INTO public.questions (
  id, session_id, student_id, title, description, code_snippet, error_message,
  what_tried, category, priority, status, queue_position,
  claimed_by, resolution_note, claimed_at, deferred_at, resolved_at, created_at
